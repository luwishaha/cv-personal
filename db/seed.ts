...
const items = [
  ...
  },
  {
    title: "经历 · 德尔玛供应链计划",
    category: "经历",
    keywords: "德尔玛,供应链,订单,排产,SRM,OMS,U9,履约",
    content:
      "广东德尔玛科技股份有限公司订单管理部供应链计划实习生（2024.09—2024.11）：负责米家和京东发货分仓，用 SRM 到库预约、OTC 数据检验，全程跟进 7 个料品，参与订单总货品数 63w，订单履约率超 98%；用 OMS 监控履约率、需求满足率、库存周转率等 KPI 并管控 DOS；用 U9 更新库存数据，参与智能家电订单分析小队，料品订单达成率提升 3%；结合分配池库存、OEM 库存与订单需求协助制定下月排产计划。",
  },
  {
    title: "技能与奖项",
    category: "技能",
